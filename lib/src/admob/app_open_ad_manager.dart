...
class AppOpenAdManager {
  AppOpenAdManager({String? adUnitId, Duration? maxCacheDuration})
    : _adUnitId = adUnitId,
    ...
    AppOpenAd.load(
      ...
      adLoadCallback: AppOpenAdLoadCallback(
        ...
        onAdFailedToLoad: (error) {
          FlutterLogger.error('AppOpenAd failed to load: $error', tag: 'ADMOB');
          _isLoadingAd = false;
          _appOpenAd = null;
        },
      ),
  ...
  void showAdIfAvailable({
    ...
    _appOpenAd!.fullScreenContentCallback = FullScreenContentCallback(
      onAdShowedFullScreenContent: (ad) {
        _isShowingAd = true;
        FlutterLogger.info(
          'AppOpenAd onAdShowedFullScreenContent',
          tag: 'ADMOB',
        );
      },
