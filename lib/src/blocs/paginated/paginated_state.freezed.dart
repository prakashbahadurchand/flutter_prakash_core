...
bool operator ==(Object other) {
  final _this = this as PaginatedState<T, F>;
  return identical(this, other) || (other.runtimeType == runtimeType&&other is PaginatedState<T, F>&&(identical(other.searchQuery, _this.searchQuery) || other.searchQuery == _this.searchQuery)&&const DeepCollectionEquality().equals(other.filter, _this.filter)&&(identical(other.status, _this.status) || other.status == _this.status)&&(identical(other.totalLoaded, _this.totalLoaded) || other.totalLoaded == _this.totalLoaded)&&(identical(other.isLastPage, _this.isLastPage) || other.isLastPage == _this.isLastPage));
}
...
int get hashCode {
  final _this = this as PaginatedState<T, F>;
  return Object.hash(runtimeType,_this.searchQuery,const DeepCollectionEquality().hash(_this.filter),_this.status,_this.totalLoaded,_this.isLastPage);
}

@override
String toString() {
  final _this = this as PaginatedState<T, F>;
  return 'PaginatedState<$T, $F>(searchQuery: ${_this.searchQuery}, filter: ${_this.filter}, status: ${_this.status}, totalLoaded: ${_this.totalLoaded}, isLastPage: ${_this.isLastPage})';
}
...
@override
int get hashCode {
    return Object.hash(runtimeType,searchQuery,const DeepCollectionEquality().hash(filter),status,totalLoaded,isLastPage);
}
