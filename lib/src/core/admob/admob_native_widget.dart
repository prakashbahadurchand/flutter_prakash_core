...
import 'package:flutter_prakash/src/core/admob/smart_custom_ad_dialog.dart';
import 'package:flutter_prakash/src/core/loggers/flutter_logger.dart';
import 'package:flutter_prakash/src/core/widgets/toast_overlay.dart';
...
class _AdMobNativeWidgetState extends State<AdMobNativeWidget>
  ...
  void _loadNativeAd() {
    ...
    final defaultTemplateStyle = widget.templateStyle ??
        NativeTemplateStyle(
    ...
    _nativeAd = NativeAd(
      ...
      nativeTemplateStyle: widget.factoryId == null ? defaultTemplateStyle : null,
